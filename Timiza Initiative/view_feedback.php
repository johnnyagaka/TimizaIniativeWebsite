  ...
  <div>
    <nav>
      <div class="nav-wrapper brown darken-2">
        <a id="top" href="admin_page.php" class="brand-logo" style="font-family:Roboto"></a><li class="brand-logo center" style="font-family:Roboto">FeedBack Recieved</li><br>
      </div></nav></div>
      <body>
        ...
        //$row = $result->fetch_assoc())
		    while($row = $result->fetch_assoc()){
                ...
                echo "<tr><td>" . $row["email"]. "</td><td>" . $row["feedback"]. 
                "</td><tr>";
                  }  
            }
